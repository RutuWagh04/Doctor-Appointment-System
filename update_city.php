...
$id=$_GET['hid'];
$cdata=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM city WHERE cid='".$id."'"));
session_start();
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="update_city.php?cid=<?php echo $cdata[0]?>" method="POST">
                                                     ...
                                                     <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                                                <input name="city" value="<?php echo $cdata[1]?>" type="text" class="form-control" />
                                                             </div>
