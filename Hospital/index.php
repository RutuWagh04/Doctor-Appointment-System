...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
       ...
       <br>
        ...
        <div class="analytics-sparkle-area">
            <div class="container-fluid">
                <?php
                $num=mysqli_num_rows(mysqli_query($con,"SELECT * FROM department  WHERE HID='".$_SESSION['hospital']."'"));
                $num2=mysqli_num_rows(mysqli_query($con,"SELECT * FROM doctor  WHERE HID='".$_SESSION['hospital']."'"));
                $num3=mysqli_num_rows(mysqli_query($con,"SELECT * FROM appointment  WHERE HID='".$_SESSION['hospital']."'"));
                ?>
                <div class="row">
