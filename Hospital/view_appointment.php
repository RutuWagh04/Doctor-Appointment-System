                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1> <span class="table-project-n">Appointment Data</span> Data</h1>
                                </div>
                            </div>
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table style="font-weight: bold;" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php
                                            $sr=1;
                                            $res=mysqli_query($con,"SELECT * FROM appointment WHERE HID='".$_SESSION['hospital']."'");
                                            while($row=mysqli_fetch_row($res))
                                            {

                                                $doctor=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM doctor WHERE did='".$row[6]."'"));
                                                $slot=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM slot WHERE ID='".$row[9]."'"));
                                                $dep=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM department WHERE DID='".$row[10]."'"));
                                            echo '
                                            <tr>
                                                ...
                                                <td>'.$dep[1].'</td>
                                                 ...
                                                 <td>
                                                    <a href="delete_appointment.php?id='.$row[0].'">
