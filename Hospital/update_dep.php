...
$cdata=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM department WHERE DID='".$_GET['id']."'"));
?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="update_dep.php?id=<?php echo $cdata[0]?>" method="POST">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                                                ...
                                                                <input value="<?php echo $cdata[1]?>" name="dep" type="text" class="form-control" />
                                                            </div>
...
if(isset($_POST['save']))
{
    ...
    if(mysqli_query($con,"UPDATE department SET D_NAME='".$dep."' WHERE DID='".$id."' "))
    {
        echo "
        <script>
