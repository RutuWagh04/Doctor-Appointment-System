...
$cdata=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM doctor WHERE did='".$_GET['id']."'"));
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="update_doctor.php?id=<?php echo $cdata[0]?>" method="POST"enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Doctor Name</label>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <input value="<?php echo $cdata[1]?>" name="doctor_name" type="text" class="form-control" />
                                                            </div>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                 <input value="<?php echo $cdata[3]?>" name="email" type="text" class="form-control" />
                                                            </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                ...
                                                                <textarea name="address" class="form-control"><?php echo $cdata[4]?></textarea>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <input value="<?php echo $cdata[2]?>" name="contact" type="number" class="form-control" />
                                                            </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <input value="<?php echo $cdata[8]?>" type="text" name="Username" class="form-control" />
                                                            </div>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <input value="<?php echo $cdata[9]?>" type="text" name="Password"class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Experience</label>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <input type="Experience" value="<?php echo $cdata[6]?>" name="experience" class="form-control" />
                                                                <input type="hidden" value="<?php echo $cdata[0]?>" name="id" class="form-control" />
                                                            </div>

                                                             <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Education</label>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <input type="text" value="<?php echo $cdata[5]?>" name="education" class="form-control" />
                                                            </div>
...
if(isset($_POST['save']))
{
    ...
    if(mysqli_query($con,"UPDATE doctor SET doctor_name='".$doctor_name."',contact='".$contact."',email='".$email."',address='".$address."',education='".$education."',experience='".$experience."',username='".$username."',password='".$password."'WHERE did='".$id."' "))
    {
        echo "
        <script>
